...
int main(void) {
    ...
    print_uart(msg);
    sprintf(msg, "Type \'help\' for help.\r\n");
    print_uart(msg);
    ...
    while (1) {
        if (gucCommandReady) {
            ...
            if (lucNStatus == CMDLINE_BAD_CMD) {
                sprintf(msg, "Bad or no command!\r\n");
                print_uart(msg);
            }

            // Handle the case of too many arguments.
            else if (lucNStatus == CMDLINE_TOO_MANY_ARGS) {
                sprintf(msg, "Too many arguments for command processor!\r\n");
                print_uart(msg);
            }
            ...
            // returned.
                ...
                sprintf(msg, "Command returned error code %s\r\n",
